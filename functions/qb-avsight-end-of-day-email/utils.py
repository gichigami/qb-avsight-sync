...
def send_email_summary(bills_update, bills_insert, invoices_updated,
    ...
    try:
        ...
        for _, row in bills_update.head(10).iterrows():
            ...
            bills_update_rows_for_template.append((display_text, bill_id, balance_due, total_amount, due_date))
        ...
        for _, row in bills_insert.head(10).iterrows():
            ...
            bills_insert_rows_for_template.append((display_text, bill_id, total_amount, balance_due, bill_date))
